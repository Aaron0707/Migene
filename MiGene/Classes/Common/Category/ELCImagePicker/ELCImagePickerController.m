...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = NSLocalizedString(@"select-photo-count", nil);
        NSString *message = [NSString stringWithFormat:NSLocalizedString(@"select-photo-message", nil), self.maximumImagesCount];
